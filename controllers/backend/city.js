...
async function retrieveStatusList(req) {
  ...
  try {
    ...
    return showErrorModal(
      types.city.RETRIEVE_STATUS_LIST_SUCCESS,
      '获取城市status列表成功',
      result
    )
  } catch (err) {
    showErrorModal(
      types.city.RETRIEVE_STATUS_LIST_FAIL,
      '获取城市status列表失败',
      null
    )
  }
...
async function retrieveCityList(req, params) {
  ...
  try {
    ...
    return showErrorModal(
      types.city.RETRIEVE_LIST_SUCCESS,
      '获取城市列表成功',
      result
    )
  } catch (err) {
    showErrorModal(types.city.RETRIEVE_LIST_FAIL, '获取城市列表失败', null)
  }
}
/**
 * @desc 新增城市
...
async function createCity(req, payload) {
  ...
  try {
    ...
    return showErrorModal(types.city.CREATE_SUCCESS, '新增城市成功', result)
  } catch (err) {
    showErrorModal(types.city.CREATE_FAIL, '新增城市失败', null)
  }
}
...
async function updateCity(req, payload) {
  ...
  try {
    ...
    return showErrorModal(types.city.UPDATE_SUCCESS, '编辑城市成功', result)
  } catch (err) {
    return showErrorModal(types.city.UPDATE_FAIL, '编辑城市失败', null)
  }
}
...
async function deleteCity(req, departId) {
  ...
  try {
    ...
    return showErrorModal(types.city.DELETE_SUCCESS, '删除城市成功', result)
  } catch (err) {
    return showErrorModal(types.city.DELETE_FAIL, '删除城市失败', null)
  }
}
